...
- (void)viewDidLoad
{
    ...
    _previewView.frame = CGRectMake(0, 0, 480, 320);
    _previewView.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.1];
    [self.view addSubview:_previewView];
    
    _recordButton = [UIButton buttonWithType:UIButtonTypeCustom];
    _recordButton.frame = CGRectMake(5, 28, 64, 64);
    _recordButton.layer.borderColor = [UIColor clearColor].CGColor;
    ...
    _stillButton = [UIButton buttonWithType:UIButtonTypeCustom];
    _stillButton.frame = CGRectMake(5, 128, 64, 64);
    _stillButton.layer.borderColor = [UIColor clearColor].CGColor;
    _stillButton.layer.borderWidth = 0.5f;
    [_stillButton setBackgroundImage:[UIImage imageNamed:@"takePicture.png"] forState:UIControlStateNormal];
    _stillButton.backgroundColor = [UIColor clearColor];
    [_stillButton addTarget:self action:@selector(snapStillImage:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:_stillButton];

    
    _cameraButton = [UIButton buttonWithType:UIButtonTypeCustom];
    _cameraButton.frame = CGRectMake(20, 290-28, 32, 32);
    _cameraButton.layer.borderColor = [UIColor clearColor].CGColor;
    _cameraButton.layer.borderWidth = 0.5f;
    [_cameraButton setBackgroundImage:[UIImage imageNamed:@"cameraIcon.png"] forState:UIControlStateNormal];
...
//                [_recordButton setBackgroundImage:[UIImage imageNamed:@"recordstop.png"] forState:UIControlStateNormal];
	...
	dispatch_async([self sessionQueue], ^{
		...
		[[self stillImageOutput] captureStillImageAsynchronouslyFromConnection:[[self stillImageOutput] connectionWithMediaType:AVMediaTypeVideo] completionHandler:^(CMSampleBufferRef imageDataSampleBuffer, NSError *error) {
			...
			if (imageDataSampleBuffer)
			{
				...
				[[[ALAssetsLibrary alloc] init] writeImageToSavedPhotosAlbum:[originalImage CGImage] orientation:(ALAssetOrientation)[originalImage imageOrientation] completionBlock:nil];
                ...
                [[CCDirector sharedDirector] pushScene:[CCTransitionFadeTR transitionWithDuration:2.0 scene:[LevelSelectionLayer sceneParameter:filePath]]];

...
//            tempImage.frame = CGRectMake(0, 0, 287, 47);
//            tempImage.contentMode = UIViewContentModeScaleAspectFit;
//            tempImage.image = [textImages objectAtIndex:i % textImages.count];
//            [temp addSubview:tempImage];
        }
...
- (void)setAnimalsImagesArray;
{
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"animalThumbnail_%d_iphone.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
            
//            //TEXT IMAGES
//            NSString *thumbImgName1 = [NSString stringWithFormat:@"animaltext%d.png", i];
//            UIImage *image1 = [UIImage imageNamed:thumbImgName1];
//            [textImages addObject:image1];
        }
    }
    else
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"animalThumbnail_%d.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
...
- (void)setBuildingsImagesArray
{
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"buildingThumbnail_%d_iphone.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
            
//            //TEXT IMAGES
//            NSString *thumbImgName1 = [NSString stringWithFormat:@"buildingtext%d.png", i];
//            UIImage *image1 = [UIImage imageNamed:thumbImgName1];
//            [textImages addObject:image1];
        }
    }
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"buildingThumbnail_%d.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
        }
    }
...
- (void)setCarsImagesArray
{
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"carThumbnail_%d_iphone.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
...
//            [textImages addObject:image1];
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"carThumbnail_%d.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
        }
    }
...
- (void)setSportsImagesArray
{
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"sportsThumbnail_%d_iphone.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
            
            
//            //TEXT IMAGES
//            NSString *thumbImgName1 = [NSString stringWithFormat:@"camel%d.png", i];
//            UIImage *image1 = [UIImage imageNamed:thumbImgName1];
//            [textImages addObject:image1];
    }
    }
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"sportsThumbnail_%d.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
        }
    }
...
- (void)setFruitsImagesArray
{
    if(IS_IPHONE_4 || IS_IPHONE_5)
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"fruitsThumbnail_%d_iphone.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
...
//            [textImages addObject:image1];
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"fruitsThumbnail_%d.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
        }
    }
...
- (void)setPersonalitiesImagesArray
{
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"personalitiesThumbnail_%d_iphone.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
...
//            [textImages addObject:image1];
    ...
    {
        for (int i = 1; i <= 6; i++) {
            NSString *thumbImgName = [NSString stringWithFormat:@"personalitiesThumbnail_%d.jpg", i];
            UIImage *image = [UIImage imageNamed:thumbImgName];
            [imageAry addObject:image];
        }
    }
        ...
        if (view.center.x > (offset - _itemSize.width ) && view.center.x < (offset + self.frame.size.width + _itemSize.width))
        {
            ...
            if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
            {
                view.frame = CGRectMake(view.frame.origin.x,
                                        self.frame.size.height - _itemSize.height - heightOffset - (addHeight/positionRatio)-45,
            ...
            else if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
            {
                ...
                {
                    view.frame = CGRectMake(view.frame.origin.x,
                                            self.frame.size.height - _itemSize.height - heightOffset - (addHeight/positionRatio)-15,
                                            _itemSize.width + addHeight,
                                            _itemSize.height + addHeight);
                }
                else
                {
                    view.frame = CGRectMake(view.frame.origin.x,
                                            self.frame.size.height - _itemSize.height - heightOffset - (addHeight/positionRatio)-10,
                                            _itemSize.width + addHeight,
                                            _itemSize.height + addHeight);

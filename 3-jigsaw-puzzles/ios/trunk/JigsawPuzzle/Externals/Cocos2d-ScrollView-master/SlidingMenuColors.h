...
@interface SlidingMenuColors : CCLayer
{
    ...
    BOOL isFromColoring;
    BOOL isFromMenuSliderPage;
    id journalDelegateObj;
}
...
@property (nonatomic, readwrite) BOOL isFromColoring;
@property (nonatomic, readwrite) BOOL isFromMenuSliderPage;

@property (nonatomic, assign)id journalDelegateObj;

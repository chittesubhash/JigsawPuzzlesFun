...
-(void)runSceneWithID:(SceneTypes)sceneID {
    ...
    switch (sceneID) {
        ...
        case kPuzzleSelection:
            sceneToRun = [CCTransitionZoomFlipX transitionWithDuration:0.5 scene:[PuzzleSelectionLayer scene]];
            break;
        case kLevelEasy:
            sceneToRun = [CCTransitionZoomFlipY transitionWithDuration:0.5 scene:[LevelEasyLayer scene]];
            break;
//        case kLevelNormal:

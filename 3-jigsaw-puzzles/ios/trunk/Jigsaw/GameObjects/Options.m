...
-(void)createLanguagesMenu{
    ...
    eng.userData = (__bridge void *)([NSNumber numberWithInt:kEnglish]);
    pt.userData = (__bridge void *)([NSNumber numberWithInt:kPortuguese]);
    es.userData = (__bridge void *)([NSNumber numberWithInt:kSpanish]);
...
-(void)createBtnVoltar{
    ...
    CCSprite *itemSprite = [[CCSprite alloc] initWithFile:@"btn-voltar.png"];
    CCMenuItemSprite *btBack = [CCMenuItemSprite itemWithNormalSprite:itemSprite selectedSprite:nil
                                                                   target:self
...
-(void)creditsAnimation{
    CCSprite *itemSprite = [[CCSprite alloc] initWithFile:@"btn-credits.png"];
    CCMenuItemSprite *creditButton = [CCMenuItemSprite itemWithNormalSprite:itemSprite selectedSprite:nil
                                                               target:self
